...
const SendMessageForBack = (props: any, shuttleDetailItem: any) => {

    props.passengersOfTheShuttle.forEach((itemPassenger: Passenger) => {

        const passengerShuttleActionsStatus = props.passengerShuttleActions.find((item: PassengerShuttleAction) => item.PassengerStatus === 0 && item.PassengerId === itemPassenger.Id)

        if (passengerShuttleActionsStatus) {
...
export default SendMessageForBack;